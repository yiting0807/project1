        ...
        <div className={styles.top}>
          ...
          <Slider {...settings}>
             <div className={styles.topimg}>
               <img className={styles.cimg} src="images/jc2.JPG" alt="t-shirt"  />
             </div>

             <div className={styles.topimg}>
                <img className={styles.cimg} src="images/jm3.jpg" alt="eve"/>
             </div>

              <div className={styles.topimg}>
               <img className={styles.cimg} src="images/ji7.jpg" alt="japanidol"/>
              </div>    
          </Slider>
         </div>
